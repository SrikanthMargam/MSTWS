...
New-NetFirewallRule -Name "WMI-I" -DisplayName "TWS_Allow_WMI_Ports" -Direction Inbound -LocalPort 135,137,1024-5000,22333,6000-6032,24158,49152-65535 -Protocol TCP -Action Allow -ErrorAction SilentlyContinue
...
New-NetFirewallRule -Name "WSUS" -DisplayName "TWS_Allow_WSUS_Port" -Direction Outbound -LocalPort 8530 -Protocol TCP -Action Allow -ErrorAction SilentlyContinue
...
function WebStoreSetup()
{
	...
	Write-FileLog -message "-----Begin-WebStore Installation------"
	...
	Write-FileLog -message ("------WebStore Installation Status:"+ $client.ExitCode)
}
